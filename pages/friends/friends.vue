	...
	<view>
		...
		<view style="display: flex;flex-direction: column;margin: 20rpx;transform: translate(0rpx,-100rpx);">
			...
			<view v-for="friend in dataForFriend" style="display: flex;flex-direction: column;">
				...
				<div style="height: 1rpx;width: 100%;background-color: #9d9d9d;margin: 30rpx;"></div>
			</view>
		</view>
	</view>
</template>
	...
	export default {
		...
		data() {
			return {
				...
				{name:"dtwang",avatar:"../../static/55.png",content:"希望以后不要发送这种事情了，实在太恐怖了",pic:['../../static/u24.png','../../static/u17.png']}],
			}
		},
		methods: {
			topage(){
